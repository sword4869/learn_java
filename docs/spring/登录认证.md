- [1. 会话跟踪技术](#1-会话跟踪技术)
- [2. Cookie（客户端会话跟踪技术）](#2-cookie客户端会话跟踪技术)
- [3. Session（服务端会话跟踪技术）](#3-session服务端会话跟踪技术)
  - [3.1. 黑马点评的例子](#31-黑马点评的例子)
  - [3.2. 发送验证码](#32-发送验证码)
  - [3.3. 登录](#33-登录)
  - [3.4. 登录拦截器（校验登录状态）](#34-登录拦截器校验登录状态)
- [4. 令牌技术](#4-令牌技术)
- [5. JWT是什么](#5-jwt是什么)
- [6. JWT怎么实现登录校验](#6-jwt怎么实现登录校验)
- [7. 为什么设置401状态码？](#7-为什么设置401状态码)
- [8. 统一拦截技术](#8-统一拦截技术)
- [9. 过滤器 Filter](#9-过滤器-filter)
- [10. 过滤器链的执行顺序](#10-过滤器链的执行顺序)
- [11. 拦截器 Interceptor](#11-拦截器-interceptor)
- [12. 多个拦截器的执行顺序](#12-多个拦截器的执行顺序)
- [13. 拦截器和controller的执行顺序](#13-拦截器和controller的执行顺序)
