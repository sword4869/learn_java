...
- [3. 优惠券秒杀](#3-优惠券秒杀)
  ...
  - [3.1. Redis 自增 ID](#31-redis-自增-id)
  - [3.2. 秒杀](#32-秒杀)
  - [3.3. 库存超卖](#33-库存超卖)
  - [3.4. 一人一单](#34-一人一单)
    - [3.4.1. synchronized锁细节](#341-synchronized锁细节)
    - [3.4.2. 分布式锁](#342-分布式锁)
      - [3.4.2.1. 不可重入的Redis分布式锁](#3421-不可重入的redis分布式锁)
      - [3.4.2.2. 可重入的Redisson分布式锁](#3422-可重入的redisson分布式锁)
      - [3.4.2.3. multiLock](#3423-multilock)
  - [3.5. 秒杀业务的优化：基于阻塞队列的异步秒杀](#35-秒杀业务的优化基于阻塞队列的异步秒杀)
