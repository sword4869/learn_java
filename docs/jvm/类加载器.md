- [1. 类的生命周期7个阶段是什么](#1-类的生命周期7个阶段是什么)
- [2. 🚀类的加载阶段做什么/类加载器的作用是什么？](#2-类的加载阶段做什么类加载器的作用是什么)
- [3. 为什么需要分别再方法区和堆上创建对象来保存信息？](#3-为什么需要分别再方法区和堆上创建对象来保存信息)
- [4. 静态变量 final 赋值的情况](#4-静态变量-final-赋值的情况)
- [5. 静态变量的结果：静态变量的初始化和静态代码块对静态变量的赋值操作顺序？](#5-静态变量的结果静态变量的初始化和静态代码块对静态变量的赋值操作顺序)
- [6. 🚀什么会导致类的初始化阶段](#6-什么会导致类的初始化阶段)
- [8. 习题](#8-习题)
- [9. 🚀类加载器有几种](#9-类加载器有几种)
- [10. 启动类加载器 Bootstrap](#10-启动类加载器-bootstrap)
- [11. 扩展类加载器和应用程序类加载器](#11-扩展类加载器和应用程序类加载器)
- [12. 🚀双亲委派机制的作用](#12-双亲委派机制的作用)
- [13. 🚀双亲委派机制的过程](#13-双亲委派机制的过程)
- [14. 🚀打破双亲委派机制](#14-打破双亲委派机制)
- [15. 自定义类加载器](#15-自定义类加载器)
- [16. 线程上下文类加载器](#16-线程上下文类加载器)
- [17. SPI机制](#17-spi机制)
...
## 5. 静态变量的结果：静态变量的初始化和静态代码块对静态变量的赋值操作顺序？
